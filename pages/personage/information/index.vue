  ...
  <view class="tf-bg tf-screen">
    ...
    <scroll-view class="tf-padding-base tab-content" :scroll-y="true">
      <template v-if="current === 0">
        ...
        <uni-list style="background-color: #fff;border-radius: 8rpx;margin-bottom: 30rpx;"><uni-list-item title="人脸采集"></uni-list-item></uni-list>
      ...
      <template v-if="current === 1">
        <view class="house-owner house-box">
          ...
          <view class="tf-row-space-between">
            ...
            <view class="tf-row-vertical-center house-people-box">
              <text class="tf-icon" style="font-size: 36rpx;">&#xe7cf;</text>
        ...
        <button class="tf-btn tf-btn-primary" type="warn" @tap="addHouse">新增房产</button>
      </template>
      <template v-if="current === 2">
        ...
        <button class="tf-btn tf-btn-primary" type="warn" @tap="addHouse">新增成员</button>
      </template>
    </scroll-view>
  </view>
</template>
